      ...
      <div class="content">
        <div class="container-fluid">
          <div class="row">
            <div class="col-md-12">
			<!--- tambah data -->
			<form class="form-horizontal" action="addpinjam.php" method="post">
			 <div class="form-row">
			...
			?>
				...
				<div class="form-group col-md-6">
				 ...
				 <option value="" disable>--- Pilih Mahasiswa ---</option>
				<?php	
				
				$q = mysqli_query($conn, "SELECT * FROM mahasiswa");
				while($data = mysqli_fetch_array($q)){
					echo '<option value="'.$data['NAMA_MAHASISWA'].'">'.$data['NAMA_MAHASISWA'].'</option>';
				}
			?>
			</select>
