          ...
          <div class="row">
			...
			<?php
				...
				if (isset($_GET['id'])) {
				  ...
				  foreach ($q as $dt) :
				  ?>
			<form class="form-horizontal" action="proses_updatebuku.php" method="post">
			 <div class="form-row">
				<div class="form-group col-md-6">
				  <label for="">ID Buku</label>
				  <input type="hidden" class="form-control" name="id" value="<?= $dt['id_buku'] ?>" >
				</div>
				<div class="form-group col-md-6">
			  ...
			  <div class="form-group col-md-6">
				  ...
				  <input type="text" class="form-control" name="tahun" value="<?= $dt['tahun'] ?>">
				</div>				
			  </div>																													
